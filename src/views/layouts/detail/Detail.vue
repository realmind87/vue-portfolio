...
<style scoped>
    .detail-wrapper {position: relative;width:100%;max-width:1050px;display:block;margin:0 auto;padding:30px;border-radius:10px;background-color:#fff;font-size:1.6rem;box-sizing:border-box;}
