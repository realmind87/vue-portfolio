...
<style scoped>
    .detail-wrapper {position: relative;width:100%;max-width:1160px;display:block;margin:0 auto;padding:20px;border-radius:10px;background-color:#fff;font-size:1.6rem;box-sizing:border-box;}
    ...
    .detail-wrapper .site-img-area {width:100%;height:300px;background-color:#757575;}
